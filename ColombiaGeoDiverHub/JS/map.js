...
$(document).ready(function () {
  ...
  var reg_colombia = L.esri.featureLayer({
   ...
   reg_colombia.addTo(map);
     ...
     // Añadimos los LIGs_ desde Arcgis.com
  ...
  var ligs_SNSM = L.esri.featureLayer({
    url: "https://services1.arcgis.com/Qrk4Z5vQ94JXkdYM/arcgis/rest/services/ligs_snsm/FeatureServer/0"
  });
  ligs_SNSM.addTo(map);

  var ligs_nuqui = L.esri.featureLayer({
    url: "https://services1.arcgis.com/Qrk4Z5vQ94JXkdYM/arcgis/rest/services/ligs_nuqui/FeatureServer/0"
  });
  ligs_nuqui.addTo(map);
